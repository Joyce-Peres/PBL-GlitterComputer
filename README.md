...
> Se a variável `PBL_CONNECTION_STRING` não estiver definida, o projeto usa conexão local integrada (Windows Authentication) definida em `PBL/PBL/DAO/ConexaoBD.cs`.
